...
include device/flowdata/qlogix/fdfiles.mk
...
TARGET_RECOVERY_FSTAB = device/flowdata/qlogix/fstab_recovery
...
PRODUCT_COPY_FILES += device/flowdata/qlogix/fstab_recovery_partition:root/fstab_recovery_partition
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/flowdata/qlogix/bluetooth
